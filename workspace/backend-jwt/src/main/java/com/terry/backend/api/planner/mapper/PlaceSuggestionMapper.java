...
public interface PlaceSuggestionMapper {
    ...
    List<PlaceSuggestionDTO> selectPlaceSuggestions(@Param("workspaceId") String workspaceId, @Param("userId") String userId);

    void insertPlaceSuggestion(@Param("placeId") String placeId, @Param("wsId") String wsId, @Param("sourceUrl") String sourceUrl, @Param("thumbnailUrl") String thumbnailUrl, @Param("title") String title, @Param("description") String description, @Param("category") String category, @Param("registId") String registId);
